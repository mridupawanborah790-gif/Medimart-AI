  ...
  return (
    <div className={`flex items-end ${isModel ? 'justify-start' : 'justify-end'}`}>
      <div className={`max-w-2xl w-auto`}>
            ...
            <>
              ...
              {isModel && !message.translatedText && message.parts[0]?.text && !message.comparisonImage && !message.isPermissionError && (
                  <button 
                      ...
                      className="mt-3 flex items-center text-xs font-semibold text-emerald-100/80 hover:text-emerald-100 disabled:opacity-50 transition-all"
                  >
        ...
        <p className={`text-[10px] mt-1 px-2 ${isModel ? 'text-left' : 'text-right'} text-emerald-100/45`}>
